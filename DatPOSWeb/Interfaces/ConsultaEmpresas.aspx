 <%@ Page    Language="vb" AutoEventWireup="false" CodeBehind="ConsultaEmpresas.aspx.vb"
    Inherits="WebApplication1.ConsultaEmpresas" MasterPageFile="/Site.Master" %>
...
<script src="../Javascript/ConsultaEmpresas.js" type="text/javascript"></script>
         ...
         <div class="row"  >
            <div class="col-sm-4" style="padding-top:10px;"   > 
                <div class="input-group"> 
                    ...
                    <a id="A1" class="disabled input-group-addon" data-toggle="modal" data-target="#modalCantudadUsuario"  runat="server" onclick="ModalUsuariosdeEmpresa();" style="border:0px;background-color: #ffffff;">
            ...
            <div class="col-sm-4" style="padding-top:10px;">
                  <span  class="has-float-label"   >
                    <input id="txtPais" maxlength="50" class="limpiar form-control moderno_tb"   runat="server" type="text" placeholder=" "/>
        ...
        <div class="row" style="padding-bottom:30px;"  >
            <div class="col-sm-4" style="padding-top:10px;"> 
                 <div class="floating-label">
                      <select class="limpiar form-control moderno_tb floating-select" id="txtTarifa"   onclick="this.setAttribute('value', this.value);" value="" runat="server">
                            <option value=""></option>
            ...
            <div class="col-sm-4" style="padding-top:10px;"> 
                 <div class="floating-label"> 
                      <select class="limpiar form-control moderno_tb floating-select" id="txtStatus" style="width:100%;" onclick="this.setAttribute('value', this.value);" value="" runat="server">
                            <option value=""></option>
                            <option value="T">Todos</option>
