 ...
 <%@ Page    Language="vb" AutoEventWireup="false" CodeBehind="ConsultaUsuarios.aspx.vb"
    Inherits="WebApplication1.ConsultaUsuarios" MasterPageFile="/Site.Master" %>
...
<script src="../Javascript/ConsultaUsuarios.js" type="text/javascript"></script>
            ...
            <div class="col-sm-4" style="padding-top:10px;" >
                    ...
                    <div class="input-group">
                       <span  class="has-float-label"   >
                        <input id="tb_codEmpresa"   maxlength="5" type="text" class="limpiar form-control moderno_tb" placeholder=" " runat="server" /> 
                        <label for="tb_codEmpresa">Codigo de Empresa</label>
                        </span>

                        <a class="disabled input-group-addon" data-toggle="modal" data-target="#modalCantudadUsuario" onclick="ModalUsuariosdeEmpresa();" style="background-color: #ffffff;border:0px">
                ...
                <div class="col-sm-4" style="padding-top:10px;">
                    <div class="floating-label"> 
                            <select class="limpiar form-control moderno_tb floating-select" id="txtStatus" onclick="this.setAttribute('value', this.value);" value="" runat="server">
                            <option value=""></option>
