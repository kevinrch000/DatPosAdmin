 <%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AdministrarUsuarios.aspx.vb" 
 Inherits="WebApplication1.AdministrarUsuarios"  MasterPageFile="/Site.Master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="contenedormaster">
   ...
   <script src="../Javascript/Usuario.js" type="text/javascript"></script>
   <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Roboto+Slab:400,700|Material+Icons">
    
    <input id="ipServidor" type="hidden" runat="server"/>
    <input id="nomServidor" type="hidden" runat="server"/>
      <%--Texto Flotante--%>
    <link href="../Styles/bootstrap-float-label.css" rel="stylesheet" type="text/css" />
    <link href="../Styles/disenoBotones.css" rel="stylesheet" type="text/css" />
    ...
    <div class="c-content-center">
         ...
         <ul class="nav nav-tabs" style="">
            ...
            <a data-toggle="tab" class="tabcito" href="#Datos" style="color: #228ac9;
                font-size: 17px;">Datos</a></li>
                 <%--<li onclick="UsuariosAsociados();"   class="active">
            <a data-toggle="tab"  class="tabcito" href="#Usuarios" style="color: #228ac9;
                font-size: 17px;">Usuarios</a></li>--%>
           ...
           <a data-toggle="tab" href="#Lista" class="tabcito" style="color: #228ac9; font-size: 17px;">
            ...
            <div class="row" >
                    <div class="col-sm-6" style="padding-top:10px;" >
                      <span  class="has-float-label"   >
                        <input id="tb_ccod_usuario" class="readonl limpiar form-control moderno_tb" maxlength="8"  type="text"  placeholder=" " readonly runat="server" />
                        <label for="tb_ccod_usuario">Codigo de Usuario</label>
                      </span>
                    </div>
                    <div class="col-sm-6" style="padding-top:10px;" >
                     <span  class="has-float-label" > 
                            <input id="tb_cdsc_usuario" class="disabled limpiar form-control moderno_tb" maxlength="80" type="text"  placeholder=" " runat="server"/>
              ...
              <div class="row">
                    <div class="col-sm-6" style="padding-top:10px;" >
                       ...
                       <span  class="has-float-label">
                       <input name="tb_cpassw" type="password" id="tb_cpassw" maxlength="50" class="disabled limpiar  form-control moderno_tb" placeholder=" " runat="server" />
                    ...
                    <div class="col-sm-6" style="padding-top:10px;" >
                        <div class="floating-label"> 
                            <select id="dl_estado" class="disabled limpiar form-control moderno_tb floating-select" oninput="this.setAttribute('value', this.value);" value=""  runat="server">
                ...
                <div class="row">
                    <div class="col-sm-6" style="padding-top:10px;">
                     <span  class="has-float-label">
                        <input id="tb_cdirec" class="disabled limpiar form-control moderno_tb"  maxlength="200" placeholder=" " runat="server"/>
                        <label for="tb_cdirec">Dirección</label>
                          </span>
                    </div>
                    <div class="col-sm-6" style="padding-top:10px;">
                     <div class="floating-label">  
                        <select class="disabled limpiar form-control moderno_tb floating-select" id="dl_rol" oninput="this.setAttribute('value', this.value);" value=""  runat="server">
                ...
                <div class="row">
                    ...
                    <span  class="has-float-label">
                      ...
                      <div class="col-sm-6" style="padding-top:10px;">
                        <span  class="has-float-label">
                            <input id="tb_telf" class="disabled limpiar form-control moderno_tb"  maxlength="25" placeholder=" "   runat="server"/>
                ...
                <div class="row">
                  <div class="col-sm-6" style="padding-top:10px;">
                    <span  class="has-float-label">
                       <input id="tb_email" class="disabled limpiar form-control moderno_tb"  maxlength="50" placeholder=" "   runat="server"/>
            ...
            <div class="row" >
                ...
                <div class="input-group">
                    ...
                    <%--<img src="/Styles/images/icon/icon_popup.png" style="margin:-11px;padding-left:8px;" >--%>
     ...
     <%--       <div id="Usuarios" class="tab-pane tabcito" style="padding: 13px;"> 

                <label id="lb_codigo" style="padding-top: 20px;padding-bottom: 20px;" ></label>
                 <label id="lb_nombre" style="padding-top: 20px;padding-bottom: 20px;padding-left:15px;" ></label>
                <table id="tableUsuariosAsociados"  style="width:100%;">
                <colgroup>
                    <col style="width:10%"></col>
                    <col style="width:10%"></col>
                    <col style="width:30%"></col>
                    ...
                    <thead id="thTablaUsuariosAsociados">
                        <tr> 
                            <th>
                                Código
                            </th>
                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse navbar-right" style="margin-right: 4.5%;">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><img src="../Styles/img/filtro.png" style="WIDTH:14PX;MARGIN-RIGHT:5PX;" />FILTROS <span class="caret"></span></a>
