...
function Limpiar() {
    ...
    $('#txtPais').val('');
    $('#txtStatus').val('');
    document.getElementById("txtTarifa").setAttribute("value", "");
...
document.getElementById("txtStatus").setAttribute("value", "");
    ...
    $('#id_titulo').text("Consulta de Empresas");
    $('#btn_p_nuevo').hide();
    $('#btn_p_editar').hide();
    $('#btn_p_grabar').hide();
    $('#btn_p_eliminar').hide();
...
function PasaDatosCodEmpresa() {
    ...
    $('#txtCodEmp').val($("#table_visible_BuscarEmpresa")[0].rows[fila[0].rowIndex].cells[1].innerText); 
}
...
function ModalUsuariosdeEmpresa() {
    ...
    $.ajax({
        type: "POST",
        url: 'ConsultaEmpresas.aspx/ConsultaUsuariosPorEmpresa',
        data: '{empresa: "' + "" + '"}',
...
function Ejecutar() {
    var txtCodEmp = document.getElementById("txtCodEmp");
    var txtTarifa = document.getElementById("txtTarifa");
    ...
    $.ajax({
        type: "POST",
        url: 'ConsultaEmpresas.aspx/ConsultasEmpresasPrincipal',
