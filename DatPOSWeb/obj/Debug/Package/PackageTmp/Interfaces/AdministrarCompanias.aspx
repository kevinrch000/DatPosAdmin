<%@ Page  Title="" Language="vb" AutoEventWireup="false" CodeBehind="AdministrarCompanias.aspx.vb"
    Inherits="WebApplication1.AdministrarCompanias" MasterPageFile="/Site.Master" %>
    <asp:Content ID="Content1" ContentPlaceHolderID="contenedormaster" runat="server">
   ...
   <script src="../Javascript/Empresa.js" type="text/javascript"></script>
                    ...
                    <div class="col-sm-6" style="padding-top: 10px;">
                        <span class="has-float-label">
                            <input id="txtcodigo" class="readonl limpiar form-control moderno_tb" maxlength="5"
                                placeholder=" " readonly runat="server" />
                            <label for="txtcodigo">
                    ...
                    <div class="col-sm-6" style="padding-top: 10px;">
                        <span class="has-float-label">
                            <select class="disabled limpiar form-control moderno_tb floating-select" onchange="CargarProvincia();"
                                id="txtDepartamento" value="" runat="server">
                            </select>
                            <label class="floating-select2">
                                Departamento</label>
                        </span>
                    ...
                    <div class="col-sm-6" style="padding-top: 10px;">
                        <span class="has-float-label">
                            <select class="disabled limpiar form-control moderno_tb floating-select" onchange="CargarDistrito();"
                                id="txtProvincia" value="" runat="server">
                            </select>
                            <label class="floating-select2">
                                Provincia</label>
                        </span>
                    ...
                    <div class="col-sm-6" style="padding-top: 10px;">
                        <span class="has-float-label">
                            <select class="disabled limpiar form-control moderno_tb floating-select" onchange="CargarUbigeo();"
                                id="txtDistrito" value="" runat="server">
                            </select>
                            <label class="floating-select2">
                                Distrito</label>
                        </span>
