...
//    $.ajax({
//        type: "POST",
//        url: 'AdministrarCompanias.php?action=CargarTarifa',
//        data: '{codigo: "' + "cod" + '" }',
...
// Inmediatamente debajo de todo esto debe seguir tu función CargarTabla() original
   ...
   function CargarTabla() {
    ...
    var obj = llenarobjeto('AdministrarCompanias.php?action=ConsultarEmpresas');
...
function Guardar() {
    ...
    $.ajax({
        type: "POST",
        url: 'AdministrarCompanias.php?action=GrabarEmpresa',
