...
<script src="<?= $base ?>/assets/Javascript/ConsultaUsuarios.js" type="text/javascript"></script>
            ...
            <div class="col-sm-4" style="padding-top:10px;" >
                    ...
                    <div class="input-group">
                       <span  class="has-float-label"   >
                        <input id="tb_codEmpresa"   maxlength="5" type="text" class="limpiar form-control moderno_tb" placeholder=" " /> 
                ...
                <div class="col-sm-4" style="padding-top:10px;">
                    <div class="floating-label"> 
                            <select class="limpiar form-control moderno_tb floating-select" id="txtStatus" onclick="this.setAttribute('value', this.value);" value="">
                            <option value=""></option>
